 ...
 * Features a sleek HUD header, 5 interactive placeholder game cards in a 3+2 layout,
 * and high-end interactive card feedback.
 */
const GamesZone = () => {
  return (
    <div className="relative min-h-[calc(100vh-5rem)] flex flex-col items-center px-4 py-8 md:py-12 select-none">
      ...
      >
        ...
        <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full border border-violet-500/30 bg-violet-950/30 text-violet-300 font-mono text-xs tracking-widest uppercase mb-4 shadow-[0_0_15px_rgba(139,92,246,0.15)]">
        ...
        <p className="text-sm sm:text-base text-slate-300 font-sans tracking-wide">
          Step in. Pick a game. Play your way.
        </p>
      </motion.div>
